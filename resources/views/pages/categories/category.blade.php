                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-danger" href="#"
                                                data-toggle="modal" data-target="#deleteModal-{{ $category->id }}"><i
                                        ...
                                        <div class="modal-content">
                                            <form action="/categories/{{ $category->id }}" method="POST">
                                                ...
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="deleteModalLabel{{ $category->id }}">Hapus
                                                        Kategori</h5>
                                                </div>
                                                <div class="modal-body" id="modalBody-{{ $category->id }}">
                                                    Apakah kamu yakin ingin menghapus kategori
                                                    <strong>{{ $category->name }}</strong>?<br>
                                                    Produk yang memiliki kategori <strong>{{ $category->name }}</strong>
                                                    akan <strong>ikut terhapus</strong>.
                                                </div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button"
                                                        data-dismiss="modal">Batal</button>
                                                    <button type="submit" id="deleteButton-{{ $category->id }}"
